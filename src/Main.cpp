...
int main() {
	...
	scene.add_object(
		std::make_shared<Object>(std::make_shared<RightPrism>(Vec3(-8, 0, 0), 5, 6, 16), Glass(GREEN), false));
	scene.add_object(
		std::make_shared<Object>(std::make_shared<RightPyramid>(Vec3(0, 10, 8), 5, 8, 3), MattePlastic(ORANGE), false));
